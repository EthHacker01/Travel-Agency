...
<body>
  ...
  <div class="container-fluid">
	...
	<div class="container-fluid" >
	  <div class="row mx-5 my-5" style="display: grid;
...
<div class="row mx-5 my-5" style="display: flex;
  justify-content: center;">
	    <div class="col-lg-4">
			<h1 class="text-danger text-center" style="font-weight:bold" width=>USERS DATA</h1>
</div>
</div>
<hr width="1880">
<br>
...
echo "
<table class='table table-striped table-bordered table-hover py-5' style='width:200%; border: 4px ; text:white; text-align: center;'>
<tr class='text-centre text-white'style='font-size:20px;
background: linear-gradient(45deg, #ff8080, #ffffb3);'>
<th> UserID </th>
<th> FullName </th>
<th> Email </th>
